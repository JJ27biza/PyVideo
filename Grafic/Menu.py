...
<<<<<<< HEAD
        self.boxBack = BoxLayout(orientation='horizontal', size_hint=(0.1, 0.1))
=======
...
>>>>>>> master
        ...
        # Video
<<<<<<< HEAD
        self.video = Video(source='../VideoStore/'+listVideo[numero+1], state='pause', size_hint=(0.8, 1))
=======
...
<<<<<<< HEAD
        try:
            if len(listVideo)>numero:
                 numero+1
                 self.video.source='../VideoStore/'+listVideo[numero]
                 self.video.state = 'stop'
                 self.video.state = 'play'
                 print(f"Reproduciendo: {listVideo[numero]}")
