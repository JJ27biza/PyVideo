#!/usr/bin/env python3
#Añadir los derechos de autor por la licencia a Adib Mohsin "pacifio"
#Se usa con los siguientes comandos python3 autocap.py generate <path_to_video> o python3 autocap.py youtube-g <youtube_link>
